...
<template>
  ...
  >
    <section>
      <div
        class="dark:bg-slate-900 dark:text-slate-100 flex flex-col justify-between items-start m-20 bg-slate-100 rounded-lg p-10"
      >
        ...
        <div class="">
          <label
            for=""
            class="px-2 dark:bg-slate-900 peer-focus:after:content-['@'] bg-slate-100 text-slate-900 dark:text-slate-100 text-lg font-light dark:text-slate-100 font-thin text-center"
            >Name:</label
          >
          <input
            type="text"
            class="dark:bg-slate-900 w-42 bg-slate-100 placeholder:text-slate-900 dark:placeholder:text-slate-100 text-lg dark:text-slate-100 placeholder:text-2xl font-thin outline-none border-b-[0.1rem] dark:border-slate-100 border-slate-900"
  ...
  <div class="dark:bg-slate-900 dark:text-slate-100" v-bind:style="style">
    ...
    <div
      alt="New Collection"
      class="flex flex-col h-1/3 fixed z-20 bottom-0 right-5 hover:-translate-x-10 duration-300 opacity-0 hover:opacity-100"
    >
      <button
        class="mb-2 text-slate-900 border-[0.2rem] text-xs bg-slate-100 rounded-full w-12 h-12 text-slate-900 hover:text-blue-600"
        @click="open = true"
      >
        Add
      </button>
      <button
        class="text-slate-900 border-[0.2rem] text-xs bg-slate-100 rounded-full w-12 h-12 text-slate-900 hover:text-blue-600"
      >
        Edit
      </button>
    </div>
